      ...
      <div className="w-full lg:w-1/2">
        <div className="text-left mb-8 md:mb-10">
          <h2 className="flex items-center gochi-hand-regular mb-10 md:mb-20">
            ...
            <span className="text-2xl md:text-3xl">Testimonies</span>
          </h2>
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white -mt-6 md:-mt-10">
            What Our Users Say
          </h2>
